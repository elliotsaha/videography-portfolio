import { Card, Flex, Header, Grid } from '@/components';
...
const PricingSection = () => (
  <Flex justifyContent="center" alignItems="center" flexDirection="column">
    <Header as="h1" render="h2" color="white" uppercase width={['90%', 'auto']}>
      Pricing Estimates
    </Header>
    ...
    >
      ...
      >
        ...
        etc. Real Estate Videography is normally a quick and snappy process. Ask
        for a quote!
      </Card>
      <Card
      ...
      <Card
        ...
        price="$500-$1000"
      >
        These would generally be events that take 6 hours or less. Depending on
        the equipment needed and the scale of the event, the price varies. Ask
        for a quote!
      </Card>
      <Card
